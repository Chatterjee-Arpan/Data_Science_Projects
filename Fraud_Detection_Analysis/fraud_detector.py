...
st.markdown('Enter transaction details to predict if it is fraudulent. Press "Predict" to check the result.')
...
newbalanceOrg = st.number_input('New Balance (Sender)', min_value=0.0, value=4000.0)
